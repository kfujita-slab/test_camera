...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PixelClk [ create_bd_port -dir O -type clk PixelClk ]
  set SerialClk [ create_bd_port -dir O -type clk SerialClk ]
  ...
  set locked [ create_bd_port -dir O -type rst locked ]
  set vid_active_video [ create_bd_port -dir O -type data vid_active_video ]
  ...
  connect_bd_net -net DVIClocking_0_SerialClk [get_bd_ports SerialClk] [get_bd_pins DVIClocking_0/SerialClk]
  ...
  connect_bd_net -net PixelClk_Generator_clk_out1 [get_bd_ports PixelClk] [get_bd_pins DVIClocking_0/PixelClk] [get_bd_pins rst_vid_clk_dyn/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins vtg/clk]
